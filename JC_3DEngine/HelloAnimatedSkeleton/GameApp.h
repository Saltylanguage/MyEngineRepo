...
private:
	...
	//TODO make shader take the same info
	//Graphics::TypedConstantBuffer<ConstantData> mConstantBuffer;

	typedef Graphics::TypedConstantBuffer<ConstantData> CB;
	typedef Graphics::TypedConstantBuffer<BoneData>BoneCB;

	CB mConstantBuffer;
	BoneCB mBoneConstantBuffer;
